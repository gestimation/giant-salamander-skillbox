...
This skills-only plugin contains `readatable` 0.7.1, `reviewcitation` 0.3.4, `samplesize200` 1.0.0-rc.6.
...
https://github.com/gestimation/giant-salamander-skillbox/releases. The cheat sheet is intentionally not bundled in the
